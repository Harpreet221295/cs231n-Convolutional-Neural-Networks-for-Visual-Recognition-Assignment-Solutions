...
def rmsprop(x, dx, config=None):
    ...
    next_x = x + (-1*config['learning_rate']*dx) / (np.sqrt(config['cache'])+config['epsilon'])
...
def adam(x, dx, config=None):
    ...
    config['learning_rate'], config['beta1'], config['beta2'], config['epsilon'], config['m'], config['v'], config['t'] = lr,beta1,beta2,eps,m,v,t
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
