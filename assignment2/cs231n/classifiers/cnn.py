...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        ############################################################################
        C,H,W = input_dim
        self.params['W1'] = np.random.normal(loc=0,size=(num_filters,C,filter_size,filter_size))*weight_scale
        self.params['b1'] = np.zeros(num_filters)

        newH = (H - 2) // 2 + 1
        newW = (W - 2) // 2 + 1

        self.params['W2'] = np.random.normal(loc=0,size=(num_filters*newH*newW,hidden_dim))*weight_scale
        self.params['b2'] = np.zeros(hidden_dim)

        self.params['W3'] = np.random.normal(loc=0,size=(hidden_dim,num_classes))*weight_scale
    ...
    def loss(self, X, y=None):
        ...
        loss += 0.5*reg*np.sum(self.params['W1']**2) + 0.5*reg*np.sum(self.params['W2']**2) + 0.5*reg*np.sum(self.params['W3']**2)
        
        dout2,grads['W3'],grads['b3'] = affine_backward(dscores, cache3)
        grads['W3'] += reg*grads['W3']
